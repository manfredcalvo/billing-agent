...
databricks bundle run billing_agent  # Required to start app with new code!
```
...
- **Deploy + Run after changes**: Run both `databricks bundle deploy` AND `databricks bundle run billing_agent`
